...
public class Controller {
    ...
    protected void removeFromMenu(String table) throws SQLException {
        PreparedStatement deleteMenuItemStmt = CONNECTION.prepareStatement("DELETE FROM '" + MENU_TABLE +
                "' WHERE deck_title = ?;");
    ...
    protected void insertCard(String table, String term, String def) throws SQLException {
        PreparedStatement insertCardStmt = CONNECTION.prepareStatement("INSERT INTO '" + table +
                "' (term, def) VALUES (?, ?);");
